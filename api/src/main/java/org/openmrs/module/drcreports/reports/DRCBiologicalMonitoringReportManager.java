...
public class DRCBiologicalMonitoringReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.drc.biologicalMonitoring.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.drc.biologicalMonitoring.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		//Add Rows
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptWithCd4Orders"), ccd, parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptWithCd4OrdersWithCD4CountBelow200"), ccd2,
		    parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptWithCd4OrdersWithCD4CountAbove200AndTBLam"), ccd3,
		    parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptWithCd4OrdersWithCD4CountBelow200AndCrAg"), ccd4,
		    parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt6Months"), ccd5,
		    parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt6MonthsLessEqual50"),
		    ccd6, parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt6MonthsGreater50LessEqual1000"), ccd7,
		    parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt6MonthsGreaterthan1000"), ccd8,
		    parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt12Months"), ccd9,
		    parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt12MonthsLessEqual50"),
		    ccd10, parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt12MonthsGreater50LessEqual1000"), ccd11,
		    parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLAt12MonthsGreaterthan1000"), ccd12,
		    parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLGT12Months"), ccd13,
		    parameterMappings);
		biologicalMonitoring.addRow(MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLGT12MonthsLessEqual50"),
		    ccd14, parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLGT12MonthsGreater50LessEqual1000"), ccd15,
		    parameterMappings);
		biologicalMonitoring.addRow(
		    MessageUtil.translate("drcreports.report.drc.ptStartedOnArtWithVLGT12MonthsGreaterthan1000"), ccd16,
		    parameterMappings);
		//Add Columns
		setColumnNames();
