...
public class OrdersReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.orders.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.orders.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		sqlDsd.setName(MessageUtil.translate("drcreports.report.orders.datasetName"));
		sqlDsd.setDescription(MessageUtil.translate("drcreports.report.orders.datasetDescription"));
		
		String sql = getStringFromResource("org/openmrs/module/drcreports/sql/orders.sql");
