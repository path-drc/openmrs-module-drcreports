...
import org.openmrs.module.drcreports.data.converter.ConceptDataTypeConverter;
import org.openmrs.module.drcreports.data.converter.ConceptNameConverter;
import org.openmrs.module.drcreports.data.converter.EncounterProviderFromIdConverter;
import org.openmrs.module.drcreports.data.converter.EncounterTypeUUIDFromEncounterIdConverter;
import org.openmrs.module.drcreports.data.converter.ObsGroupFromIdConvertor;
import org.openmrs.module.drcreports.data.converter.ObsProviderFromIdConverter;
import org.openmrs.module.drcreports.data.converter.ObsValueFromIdConverter;
import org.openmrs.module.drcreports.data.converter.VisitLocationFromIdConverter;
import org.openmrs.module.drcreports.data.converter.VisitTypeFromIdConverter;
import org.openmrs.module.drcreports.data.converter.VisitUUIDFromIdConverter;
import org.openmrs.module.drcreports.data.obs.definition.ObsDatetimeDataDefinition;
import org.openmrs.module.drcreports.library.BasePatientDataLibrary;
import org.openmrs.module.drcreports.library.EncounterDataLibrary;
import org.openmrs.module.drcreports.library.ObsDataLibrary;
...
@Component(DRCReportsConstants.COMPONENT_REPORTMANAGER_PATIENTHISTORY)
public class PatientHistoryReportManager extends ActivatedReportManager {
	...
	private PatientDataSetDefinition createDemographicsDataSetDefinition(MessageSourceService i18nTranslator) {
		...
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.identifier"),
		    builtInPatientDataLibrary.getPreferredIdentifierIdentifier());
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.firstname"),
		    builtInPatientDataLibrary.getPreferredGivenName());
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.lastname"),
		    builtInPatientDataLibrary.getPreferredFamilyName());
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.dob"),
		    basePatientDataLibrary.getBirthdate());
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.age"),
		    basePatientDataLibrary.getAgeAtEndInYears());
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.gender"),
		    builtInPatientDataLibrary.getGender());
		addColumn(patientDataSetDef, i18nTranslator.getMessage("drcreports.patienthistory.demographics.fulladdress"),
