...
public class DRCArtFirstLineFifteenYearsAndAboveReportManager extends ActivatedReportManager {
	...
	public boolean isActivated() {
		return inizService.getBooleanFromKey("report.drc.artFirstLine15YearsAndAbove.active", true);
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.drc.artFirstLineFifteenYearsAndAbove.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.drc.artFirstLineFifteenYearsAndAbove.reportDescription");
	}
