...
public class DRCHivStageReportManager extends ActivatedReportManager {
	...
	public boolean isActivated() {
		return inizService.getBooleanFromKey("report.drc.hivStage.active", true);
	}
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.drc.hivStage.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.drc.hivStage.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		hivStage3And4.addRow(MessageUtil.translate("drcreports.report.drc.hivStage.reportName"), ccd, parameterMappings);
		...
		hivStage3And4.addColumn(col5, createCohortComposition(_1To4y), ageParameterMappings);
		...
		hivStage3And4.addColumn(col6, createCohortComposition(_5To9y), ageParameterMappings);
		...
		hivStage3And4.addColumn(col7, createCohortComposition(_10To14y), ageParameterMappings);
		...
		hivStage3And4.addColumn(col8, createCohortComposition(_15To19y), ageParameterMappings);
		...
		hivStage3And4.addColumn(col9, createCohortComposition(_20To24y), ageParameterMappings);
		...
		hivStage3And4.addColumn(col10, createCohortComposition(_25To49y), ageParameterMappings);
		...
		hivStage3And4.addColumn(col11, createCohortComposition(_50andAbove), ageParameterMappings);
