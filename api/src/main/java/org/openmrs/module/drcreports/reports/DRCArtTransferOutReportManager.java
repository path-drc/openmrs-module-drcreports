...
public class DRCArtTransferOutReportManager extends ActivatedReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		artTransferOut.addColumn(col4, createCohortComposition(under1y), ageParameterMappings);
		...
		artTransferOut.addColumn(col5, createCohortComposition(_1To4y), ageParameterMappings);
		...
		artTransferOut.addColumn(col6, createCohortComposition(_5To9y), ageParameterMappings);
		...
		artTransferOut.addColumn(col7, createCohortComposition(_10To14y), ageParameterMappings);
		...
		artTransferOut.addColumn(col8, createCohortComposition(_15To19y), ageParameterMappings);
		...
		artTransferOut.addColumn(col9, createCohortComposition(_20To24y), ageParameterMappings);
		...
		artTransferOut.addColumn(col10, createCohortComposition(_25To49y), ageParameterMappings);
		...
		artTransferOut.addColumn(col11, createCohortComposition(_50andAbove), ageParameterMappings);
