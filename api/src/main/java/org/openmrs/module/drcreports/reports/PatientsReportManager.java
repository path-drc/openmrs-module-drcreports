...
public class PatientsReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.patients.reportName");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		sqlDsd.setName(MessageUtil.translate("drcreports.report.patients.datasetName"));
		sqlDsd.setDescription(MessageUtil.translate("drcreports.report.patients.datasetDescription"));
		
		String sql = getStringFromResource("org/openmrs/module/drcreports/sql/patients.sql");
