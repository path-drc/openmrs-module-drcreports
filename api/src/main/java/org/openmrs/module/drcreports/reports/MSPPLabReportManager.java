...
public class MSPPLabReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.MSPP.lab.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.MSPP.lab.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		String rawSql = getStringFromResource("org/openmrs/module/drcreports/sql/MSPPlab.sql");
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		ReportDesign reportDesign = ReportManagerUtil.createExcelTemplateDesign("988d3408-9aac-4b6f-9cab-77c3f02beef5",
		    reportDefinition, "org/openmrs/module/drcreports/reportTemplates/labReportTemplate.xls");
