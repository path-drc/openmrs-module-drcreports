...
public class DRCArtFirstLineBelowFifteenYearsReportManager extends ActivatedReportManager {
	...
	public boolean isActivated() {
		return inizService.getBooleanFromKey("report.drc.artFirstLineBelow15Years.active", true);
	}
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.drc.artFirstLineBelowFifteenYears.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.drc.artFirstLineBelowFifteenYears.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		artFirstLineBelowFifteenYears.addRow(MessageUtil.translate("drcreports.report.drc.ABC+3TC+pDTG"), ccd,
		    parameterMappings);
		artFirstLineBelowFifteenYears.addRow(MessageUtil.translate("drcreports.report.drc.ABC+3TC+LPV"), ccd3,
		    parameterMappings);
