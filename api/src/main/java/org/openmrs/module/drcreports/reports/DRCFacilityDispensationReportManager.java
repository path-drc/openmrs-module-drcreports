...
public class DRCFacilityDispensationReportManager extends ActivatedReportManager {
	...
	public boolean isActivated() {
		return inizService.getBooleanFromKey("report.drc.facilityDispensation.active", true);
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		facilityDispensation.addColumn(col4, createCohortComposition(under1y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col5, createCohortComposition(_1To4y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col6, createCohortComposition(_5To9y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col7, createCohortComposition(_10To14y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col8, createCohortComposition(_15To19y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col9, createCohortComposition(_20To24y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col10, createCohortComposition(_25To49y), ageParameterMappings);
		...
		facilityDispensation.addColumn(col11, createCohortComposition(_50andAbove), ageParameterMappings);
