...
public class DRCArtTransferInReportManager extends ActivatedReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		artTranferIn.addColumn(col4, createCohortComposition(under1y), ageParameterMappings);
		...
		artTranferIn.addColumn(col5, createCohortComposition(_1To4y), ageParameterMappings);
		...
		artTranferIn.addColumn(col6, createCohortComposition(_5To9y), ageParameterMappings);
		...
		artTranferIn.addColumn(col7, createCohortComposition(_10To14y), ageParameterMappings);
		...
		artTranferIn.addColumn(col8, createCohortComposition(_15To19y), ageParameterMappings);
		...
		artTranferIn.addColumn(col9, createCohortComposition(_20To24y), ageParameterMappings);
		...
		artTranferIn.addColumn(col10, createCohortComposition(_25To49y), ageParameterMappings);
		...
		artTranferIn.addColumn(col11, createCohortComposition(_50andAbove), ageParameterMappings);
