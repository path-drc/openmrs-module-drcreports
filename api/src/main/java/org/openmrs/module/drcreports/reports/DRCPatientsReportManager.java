...
public class DRCPatientsReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.drc.patients.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.patients.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		sqlDsd.setName(MessageUtil.translate("drcreports.report.drc.patients.datasetName"));
		sqlDsd.setDescription(MessageUtil.translate("drcreports.report.patients.datasetDescription"));
		
		String sql = getStringFromResource("org/openmrs/module/drcreports/sql/DRCpatients.sql");
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		...
		ReportDesign design = ReportManagerUtil.createExcelTemplateDesign("1462401f-c21f-4d12-b4f6-936d9cf76d5b",
		    reportDefinition, "org/openmrs/module/drcreports/reportTemplates/drcAdvanceHIV.xls");
