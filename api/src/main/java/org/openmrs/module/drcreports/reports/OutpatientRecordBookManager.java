...
import org.openmrs.module.drcreports.data.converter.AddressAndPhoneConverter;
import org.openmrs.module.drcreports.data.converter.CodedToShortNameConverter;
import org.openmrs.module.drcreports.data.converter.DistanceFromHealthCenterConverter;
import org.openmrs.module.drcreports.data.converter.GenderConverter;
import org.openmrs.module.drcreports.data.converter.NullToNAConverter;
import org.openmrs.module.drcreports.data.converter.ObsBooleanConverter;
import org.openmrs.module.drcreports.data.converter.OrderConverter;
import org.openmrs.module.drcreports.data.converter.RoundNumber;
import org.openmrs.module.drcreports.definition.data.CalculatedObsDataDefinition;
import org.openmrs.module.drcreports.definition.data.ContactInfoDataDefinition;
import org.openmrs.module.drcreports.definition.data.IMCIProgramDataDefinition;
import org.openmrs.module.drcreports.definition.data.ObsOnAgeDataDefinition;
import org.openmrs.module.drcreports.definition.data.PersonNameAndAttributesDataDefinition;
import org.openmrs.module.drcreports.definition.data.CalculatedObsDataDefinition.Operator;
...
public class OutpatientRecordBookManager extends ActivatedReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.identifier.label"), piDD, null);
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.patientName.label"), nameDD, null);
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.guardianName.label"), paDD1, null);
		
		String isOfCategoryLabel = MessageUtil.translate("drcreports.report.outpatientRecordBook.isOfCategory.label");
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory1.label"), ageDD,
		    (String) null, ageConverter1);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory2.label"), ageDD,
		    (String) null, ageConverter2);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory3.label"), ageDD,
		    (String) null, ageConverter3);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory4.label"), ageDD,
		    (String) null, ageConverter4);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory5.label"), ageDD,
		    (String) null, ageConverter5);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory6.label"), ageDD,
		    (String) null, ageConverter6);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory7.label"), ageDD,
		    (String) null, ageConverter7);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.ageCategory8.label"), ageDD,
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.genderCategoryMale.label"),
		    builtInPatientData.getGender(), (String) null, maleConverter);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.genderCategoryFemale.label"),
		    builtInPatientData.getGender(), (String) null, femaleConverter);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.genderCategoryOther.label"),
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.gestationalAge.label"), gestationObsDD,
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.addressAndPhone.label"), ciDD, null,
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.referredFrom.label"), referredFromDD,
		    null, obsListValueConverter);
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.newCase.label"), newCaseDD, null,
		    falseConverter);
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.oldCase.label"), newCaseDD, null,
		    trueConverter);
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.symptoms.label"), symptomsDD, null,
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.diagnosis.label"), diagnosisDD, null,
		    obsListValueConverter);
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.treatment.label"), orderDD,
		...
		NullToNAConverter nullToNAConverter = new NullToNAConverter(
		        MessageUtil.translate("drcreports.report.outpatientRecordBook.na.label"));
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.imciProgram.label"), imciDD,
		...
		// Nutritional Weight/Age
		{
			...
			agePersonDD.addParameter(new Parameter("effectiveDate", "Effective Date", Date.class));
			{
				...
				vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.weightOnAge.label"), obsOnAge,
		...
		// Nutritional Weight:Height
		{
			...
			vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.weightOnHeight.label"),
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.referredTo.label"), referredToDD, null,
		    obsListValueConverter);
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.paymentType.label"), paymentTypeDD,
		...
		vdsd.addColumn(MessageUtil.translate("drcreports.report.outpatientRecordBook.otherNotes.label"), otherNotesDD, null,
		    obsListValueConverter);
