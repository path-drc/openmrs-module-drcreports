...
public class DRCHivCaScreeningReportManager extends ActivatedReportManager {
	...
	public boolean isActivated() {
		return inizService.getBooleanFromKey("report.drc.hivCaScreening.active", true);
	}
	...
	public String getName() {
		return MessageUtil.translate("drcreports.report.drc.hivCaScreening.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("drcreports.report.drc.hivCaScreening.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		hivCaScreening.addRow(MessageUtil.translate("drcreports.report.drc.caScreening"), ccd, parameterMappings);
	...
	private void setColumnNames() {
		...
		col1 = MessageUtil.translate("drcreports.report.drc.thirtyTofortyNineFemale.label");
