...
public class DRCHIVTBCoInfectionReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("commonreports.report.drc.hivTBCoInfection.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("commonreports.report.drc.hivTBCoInfection.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.newHivTBCoInfection"), ccd,
		    parameterMappings);
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.presumptiveTBSigns"), ccd2,
		    parameterMappings);
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.tBTestDoneGeneExpert"), ccd3, null);
		
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.tBTestDoneZiehl"), ccd4, parameterMappings2);
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.tbClinicalDx"), ccd5, parameterMappings2);
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.newHIVStartedTBProphylaxis"), ccd6,
		    parameterMappings2);
		hivTBCoInfection.addRow(MessageUtil.translate("commonreports.report.drc.ptLivingWithHIVTBProphylaxisCompleted"),
		    ccd7, parameterMappings2);
