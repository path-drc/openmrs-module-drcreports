...
public class DRCArtTranferInReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("commonreports.report.drc.artTranferIn.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("commonreports.report.drc.artTranferIn.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		// What you want to do? -> Transfer-In
