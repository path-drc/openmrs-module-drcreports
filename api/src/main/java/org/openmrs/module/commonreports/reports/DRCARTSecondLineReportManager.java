...
public class DRCARTSecondLineReportManager extends ActivatedReportManager {
	...
	public String getName() {
		return MessageUtil.translate("commonreports.report.drc.artSecondLine.reportName");
	}
	
	@Override
	public String getDescription() {
		return MessageUtil.translate("commonreports.report.drc.artSecondLine.reportDescription");
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		artSecondLine.addRow(MessageUtil.translate("commonreports.report.drc.AZT+3TC+LPV+r"), ccd, parameterMappings);
		artSecondLine.addRow(MessageUtil.translate("commonreports.report.drc.AZT+3TC+ATV+r"), ccd2, parameterMappings);
