...
import org.openmrs.module.drcreports.reports.PatientHistoryReportManager;
...
public class PatientHistoryManagerTest extends BaseModuleContextSensitiveMysqlBackedTest {
	...
	@Autowired
	@Qualifier(DRCReportsConstants.COMPONENT_REPORTMANAGER_PATIENTHISTORY)
	private ActivatedReportManager reportManager;
	
	@Before
	public void setUp() throws Exception {
		executeDataSet("org/openmrs/module/reporting/include/ReportTestDataset-openmrs-2.0.xml");
		executeDataSet("org/openmrs/module/drcreports/include/patientHistoryManagerTestDataset.xml");
	}
	...
	public void evaluate_shouldReturnOnlySpecificEncounter() throws Throwable {
		...
		if (patientSummaryResult.getErrorDetails() != null) {
			...
			// api/src/test/resources/org/openmrs/module/drcreports/include/outpatientConsultationTestDataset.xml
