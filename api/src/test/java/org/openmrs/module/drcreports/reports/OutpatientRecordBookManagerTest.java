...
public class OutpatientRecordBookManagerTest extends BaseModuleContextSensitiveMysqlBackedTest {
	...
	@Autowired
	@Qualifier(DRCReportsConstants.COMPONENT_REPORTMANAGER_OPDRECBOOK)
