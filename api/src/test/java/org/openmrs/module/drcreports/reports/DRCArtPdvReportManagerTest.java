...
public class DRCArtPdvReportManagerTest extends BaseModuleContextSensitiveMysqlBackedTest {
	...
	private Map<String, Integer> getColumnValues() {
		...
		map.put("DRC Patients on ART PDV.Females", 1);
		map.put("DRC Patients on ART PDV.Males", 1);
		map.put("DRC Patients on ART PDV.All", 2);
		map.put("DRC Patients on ART PDV.Below 1 year", 0);
		map.put("DRC Patients on ART PDV.1-4 years", 0);
		map.put("DRC Patients on ART PDV.5-9 years", 0);
		map.put("DRC Patients on ART PDV.10-14 years", 0);
		map.put("DRC Patients on ART PDV.15-19 years", 0);
		map.put("DRC Patients on ART PDV.20-24 years", 1);
		map.put("DRC Patients on ART PDV.25-49 years", 1);
		map.put("DRC Patients on ART PDV.50+ years", 0);
