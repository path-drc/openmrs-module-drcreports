...
public class DRCFacilityBasedArtDeliveryReportManagerTest extends BaseModuleContextSensitiveMysqlBackedTest {
	...
	@Autowired
	private DRCFacilityBasedArtDeliveryReportManager manager;
	...
	public void setUp() throws Exception {
		...
		executeDataSet("org/openmrs/module/drcreports/include/DRCFacilityBasedArtDeliveryReportTestDataset.xml");
	...
	public void setupReport_shouldCreateCsvDesign() throws Exception {
		...
		// verify
		assertThat(rs.getReportDesignByUuid("637aa0c0-c6ea-435b-a43d-21f01fd8af42"), is(notNullValue()));
	}
	...
	private Map<String, Integer> getColumnValues() {
		...
		map.put("DRC Facility Based ART Delivery Report.Females", 1);
		map.put("DRC Facility Based ART Delivery Report.Males", 0);
		map.put("DRC Facility Based ART Delivery Report.All", 1);
		map.put("DRC Facility Based ART Delivery Report.Below 1 year", 0);
		map.put("DRC Facility Based ART Delivery Report.1-4 years", 0);
		map.put("DRC Facility Based ART Delivery Report.5-9 years", 0);
		map.put("DRC Facility Based ART Delivery Report.10-14 years", 0);
		map.put("DRC Facility Based ART Delivery Report.15-19 years", 0);
		map.put("DRC Facility Based ART Delivery Report.20-24 years", 0);
		map.put("DRC Facility Based ART Delivery Report.25-49 years", 1);
		map.put("DRC Facility Based ART Delivery Report.50+ years", 0);
