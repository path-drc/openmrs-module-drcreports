...
import org.openmrs.module.drcreports.reports.MSPPAntenatalReportManager;
...
public class MSPPAntenatalReportManagerTest extends BaseModuleContextSensitiveMysqlBackedTest {
	...
	@Autowired
	@Qualifier(DRCReportsConstants.COMPONENT_REPORTMANAGER_ANTENATAL)
	private ActivatedReportManager manager;
	
	@Before
	public void setUp() throws Exception {
		executeDataSet("org/openmrs/module/reporting/include/ReportTestDataset-openmrs-2.0.xml");
		executeDataSet("org/openmrs/module/drcreports/include/MSPPantenatalTestDataset.xml");
