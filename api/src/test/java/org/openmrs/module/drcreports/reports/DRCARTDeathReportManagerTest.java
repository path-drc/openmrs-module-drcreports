...
public class DRCARTDeathReportManagerTest extends BaseModuleContextSensitiveTest {
	...
	public void setup() throws Exception {
		...
		executeDataSet("org/openmrs/module/commonreports/include/DRCARTDeathReportTestDataset.xml");
	...
	private Map<String, Integer> getColumnValues() {
		...
		map.put("DRC Dead Patients on ART.Females", 1);
		map.put("DRC Dead Patients on ART.Males", 0);
		map.put("DRC Dead Patients on ART.All", 1);
		map.put("DRC Dead Patients on ART.Below 1 year", 0);
		map.put("DRC Dead Patients on ART.1-4 years", 0);
		map.put("DRC Dead Patients on ART.5-9 years", 0);
		map.put("DRC Dead Patients on ART.10-14 years", 0);
		map.put("DRC Dead Patients on ART.15-19 years", 0);
		map.put("DRC Dead Patients on ART.20-24 years", 0);
		map.put("DRC Dead Patients on ART.25-49 years", 1);
		map.put("DRC Dead Patients on ART.50+ years", 0);
